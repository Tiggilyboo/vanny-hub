...
#define DEVICE_FAILED_TO_RESPOND 0x0B

// PDU constants
#define CRC_LENGTH 0x02
#define ERROR_BIAS = 0x80
#define RESPONSE_HDR_LENGTH = 0x02
#define ERROR_RESP_LEN = 0x05
#define FIXED_RESP_LEN = 0x08
#define MBAP_HDR_LENGTH = 0x07

static const short CRC16_TABLE[256] = {
...
// 8 + 16 + 16 = 40
packet(unsigned char command, unsigned short starting_address, unsigned short quantity) {
